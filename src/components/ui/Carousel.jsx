    ...
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        ...
        >
          ...
          {/* pl-0 para que las cartas arranquen pegadas al borde izquierdo */}
<div className="flex flex-row justify-start gap-4">
        ...
        <div className="mr-10 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-16 w-16 items-center justify-center rounded-full bg-[#1e1e1e] disabled:opacity-50"
            onClick={scrollLeft}
            disabled={!canScrollLeft}
          >
            <IconArrowNarrowLeft size={40} color="white" stroke={1.5} />
          </button>
          <button
            className="relative z-40 flex h-16 w-16 items-center justify-center rounded-full bg-[#1e1e1e] disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight size={40} color="white" stroke={1.5} />
          </button>
        </div>
      </div>
    ...
    <>
      ...
      >
        ...
        <div className="relative z-40 p-8">
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="mt-2 max-w-xs text-left font-sans text-xl font-semibold text-white md:text-3xl [text-wrap:balance]"
          >
            {card.title}
          </motion.p>
        </div>
